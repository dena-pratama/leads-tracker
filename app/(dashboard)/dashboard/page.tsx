        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-500 bg-white px-3 py-2 rounded-md border shadow-sm">
                                ...
                                {leads.length > 0 ? leads.slice(0, 5).map(lead => (
                                    <div key={lead.id} className="flex items-center justify-between border-b pb-2 last:border-0">
                                        <div>
                                            ...
                                            <div className="text-xs text-gray-500">{lead.platform} • {lead.created_at.split('T')[0]}</div>
                                        </div>
